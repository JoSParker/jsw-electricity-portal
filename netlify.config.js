...
module.exports = {
  ...
  processFolders: ['./dist/jsw/browser'],
  ...
  onPostBuild: async ({ utils }) => {
    ...
    fs.writeFileSync(path.join('./dist/jsw/browser', '_redirects'), redirectsContent);
    console.log('Created _redirects file');

    // Also generate a _headers file
    const headersContent = '/*\n  Cache-Control: no-cache\n  X-Frame-Options: DENY';
    fs.writeFileSync(path.join('./dist/jsw/browser', '_headers'), headersContent);
